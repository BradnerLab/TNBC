...
pdf(file='figures/141016_brd4_change_expression.pdf',width = 6,height =4)
boxplot(m[gainedRows,2],m[conservedRows,2],m[lostRows,2],cex=0,col=c('red','grey','blue'),cex=0,ylim =c(-2.5,2.5),names=c('gained','conserved','lost'),ylab='Log2 fold change in exprssion',main='Chromatin changes based off of BRD4 Chip-Seq')
