...
chemseqMapped = read.table('mappedFolder/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500_SUM149_BRD4_DMSO.txt',sep='\t',header=TRUE)

brd4Mapped = read.table('mappedFolder/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500_SUM149_BRD4_DMSO.txt',sep='\t',header=TRUE)

brd4JQ1Mapped = read.table('mappedFolder/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500_SUM149_BRD4_JQ1.txt',sep='\t',header=TRUE)

wceMapped = read.table('mappedFolder/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500_SUM149_WCE_DMSO.txt',sep='\t',header=TRUE)

h3k27acMapped = read.table('mappedFolder/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500_SUM149_H3K27AC_DMSO.txt',sep='\t',header=TRUE)

h3k27acJQ1Mapped = read.table('mappedFolder/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500/HG19_ENRICHED_SUM149_BRD4_DMSO_-500_+500_SUM149_H3K27AC_JQ1.txt',sep='\t',header=TRUE)
...
colnames(m) = c('SUM149_BRD4_DMSO','SUM149_BRD4_DMSO','SUM149_BRD4_JQ1','SUM149_H3K27AC_DMSO','SUM149_H3K27AC_DMSO')
 
#keep only rows w/ signal
sigRows = which(apply(m,1,min) > 0)
m = m[sigRows,]
#=========================================================================
...
pdf(file='figures/150701_tnbc_sum149_binned.pdf',width = 8,height =4)

par(mfrow=c(1,2))
boxplot(boxMatrixBRD4,cex=0,col='red',ylim =c(-6,2),ylab='Log2 fold change in BRD4',xlab='Regions ranked by increasing BRD4 binding')
boxplot(boxMatrixH3K27AC,cex=0,col='blue',ylim =c(-6,2),ylab= 'Log2 fold change in H3K27ac',xlab='Regions ranked by increasing BRD4 binding')
